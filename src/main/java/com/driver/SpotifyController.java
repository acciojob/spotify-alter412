...
public class SpotifyController {
    ...
    public String createUser(@RequestParam(name = "name") String name,@RequestParam String mobile){
        ...
        User u = spotifyService.createUser(name,mobile);
        return "Success";
    }
    ...
    public String createArtist(@RequestParam(name = "name") String name){
        ...
        Artist a = spotifyService.createArtist(name);
        return "Success";
    }
    ...
    public String createAlbum(@RequestParam(name = "title") String title,@RequestParam String artistName){
        ...
        Album a = spotifyService.createAlbum(title,artistName);
        return "Success";
    }

    @PostMapping("/add-song")
    public String createSong(@RequestParam String title,@RequestParam String albumName,@RequestParam int length) throws Exception{
    ...
    public String createPlaylistOnLength(@RequestParam String mobile,@RequestParam String title,@RequestParam int length) throws Exception{
        ...
        Playlist p = spotifyService.createPlaylistOnLength(mobile,title,length);
        return "Success";
    }

    @PostMapping("/add-playlist-on-name")
    public String createPlaylistOnName(@RequestParam String mobile,@RequestParam String title,@RequestParam List<String> songTitles) throws Exception{
        //Create a playlist with given title and add all songs having the given titles in the database to that playlist
        //The creater of the playlist will be the given user and will also be the only listener at the time of playlist creation
        //If the user does not exist, throw "User does not exist" exception
        Playlist p = spotifyService.createPlaylistOnName(mobile,title,songTitles);
        return "Success";
    }
    ...
    public Playlist findPlaylist(@RequestParam String mobile,@RequestParam String playlistTitle) throws Exception{
        ...
        Playlist p = spotifyService.findPlaylist(mobile,playlistTitle);
        return p;
    }
    ...
    public Song likeSong(@RequestParam String mobile,@RequestParam String songTitle) throws Exception{
        ...
        Song s = spotifyService.likeSong(mobile,songTitle);
        return s;
    }
